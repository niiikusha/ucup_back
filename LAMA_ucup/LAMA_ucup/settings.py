...
class Base(Configuration):
    ...
    ALLOWED_HOSTS =  ['192.168.6.168', 'localhost', '127.0.0.1',] #[env('ALLOWED_HOSTS')]
...
# SECRET_KEY = 'django-insecure-m7)sfdmuv+%%6h5rvbyp=o$c-2cxyy9yus9qfok$sts_s8&o5h'

# # SECURITY WARNING: don't run with debug turned on in production!
# DEBUG = True

# ALLOWED_HOSTS = ['192.168.6.168', 'localhost', '127.0.0.1', '8001', '3001', '0.0.0.0']
...
#         'USER': 'postgres',
#         'PASSWORD': '12345678',
#         'HOST': 'localhost',  # Или адрес вашей PostgreSQL базы данных, если она находится на другом сервере.
#         #'PORT': '',  # Укажите порт, если он отличается от стандартного порта PostgreSQL (обычно 5432).
#         'OPTIONS': {
#              'client_encoding': 'UTF8',  # Здесь укажите нужную кодировку.
#         },
#     }
# }
